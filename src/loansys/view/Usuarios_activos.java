...
// creaccion de la tabla y boton para cambiar estado
        ...
        botonA.setBorder(BorderFactory.createLineBorder(Color.WHITE, 10, true));// Borde redondeado para el botón
        botonA.setBackground(Color.white);
        ...
        panel10.add(botonA, BorderLayout.WEST);
        panel7.setBorder(
