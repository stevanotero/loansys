...
public class ModificarUsuario extends Plantilla_Administrador {
   ...
   private Container contenedor;
    ...
    public ModificarUsuario() {
        ...
        modificar.setBorder(BorderFactory.createLineBorder(Color.gray, 10, true));
        modificar.setBackground(Color.gray);
